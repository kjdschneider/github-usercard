const axiosGitKJ = axios.get('https://api.github.com/users/kjdschneider');
console.log(axiosGitKJ);
...
axiosGitKJ.then(response => {
  parentComponent.appendChild(cardCreate(response))
});
...
followersArray.forEach(username => {
  const newAxiosGet = axios.get(`https://api.github.com/users/${username}`);
  newAxiosGet.then(response => {
    parentComponent.appendChild(cardCreate(response));
  })
